...
public class Probador {
	...
	public static void main(String[] args) {
			...
			//Obtener JSON de aplicacion -- para poder probarlo hay que incluir la dependencia con jersey-media-json-jackson 
			//System.out.println(servicio.path("rest").path("todos").
			...
			Response checkDelete = servicio.path("rest").path("todos/1").
			...
			//Obtener que todos los Todos con identificador 1 han debido ser eliminados
			System.out.println(servicio.path("rest").path("todos").
					request().accept(MediaType.APPLICATION_XML).get(String.class));
			...
			System.out.println("Form response " + respuesta.getStatus());
